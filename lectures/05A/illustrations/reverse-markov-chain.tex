...
\node[state] (X2) [right of=X1, fill=red, 
opacity = 0.3, draw opacity=1,  draw=red, line width=2pt, text opacity =1] {$\hspace{0.5em}X_{i}\hspace{0.5em}$}; 
\node[state, fill=LimeGreen, draw=blue, line width=2pt] (X3) [right of=X2] {$X_{i+1}$};                   
\node[state, fill=SpringGreen, draw=blue, line width=2pt] (X4) [right of=X3] {$X_{i+2}$};                   
\node[state, fill=LimeGreen, draw=blue, line width=2pt] (X5) [right of=X4] {$X_{i+3}$};                                     
