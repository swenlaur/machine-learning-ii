...
\node[state, fill=OliveGreen, draw=red, line width=2pt] (X2) [right of=X1] {$B$};                   
\node[state, fill=LimeGreen] (X3) [right of=X2] {$C$};                   
\node[state, fill=LimeGreen] (X4) [right of=X3] {$D$};                   
...
\node[box, fill=red, opacity=0.3, text opacity=1, draw opacity=1][below=0.5cm of X1](P1){$\pi_A$};                  
\node[box, fill=SpringGreen][below=0.5cm of X2](P2){$\pi_B$};                  
