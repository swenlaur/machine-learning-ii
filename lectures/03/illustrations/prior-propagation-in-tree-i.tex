...
\node[state, fill=OliveGreen]  (X1)               {$A$}; 
\node[state, fill=blue] (X2) [right of=X1] {$D$};
\node[state, fill=blue] (X3) [above=1.5cm of X2]        {$B$};                   
\node[state, fill=blue] (X4) [below=1.5cm of X2]        {$C$};                   
\node (X5) [right of=X2] {};
\node[state] (X6) [right of=X3] {$E$};                   
\node[state] (X7) [right of=X4] {$F$}; 

\node[box, fill=SpringGreen][below=0.3cm of X1](P1){$\pi_A,\lambda_A,\textcolor{red}{p_A}$};                  
