...
\node[state, fill=OliveGreen, draw=red, line width=2pt]  (X3) [right of=X2] {$C$};                   
...
\node[box, fill=red, opacity=0.3, text opacity=1, draw opacity=1][below=0.5cm of X2](P2){$\pi_B$};                  
\node[box, fill=SpringGreen][below=0.5cm of X3](P3){$\pi_C$};                  
