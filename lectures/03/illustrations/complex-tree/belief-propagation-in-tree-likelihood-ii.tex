...
\node[state, fill=OliveGreen, draw=blue, line width=2pt] (X4) [right of=X3] {$D$};                   
...
\node[state] (Y4) [below=3.5cm of X3, right of=X3] {$H$};                   
\node[state, fill=LimeGreen] (Y5) [right of=Y4] {$I$};                   
\node[state] (Y6) [right of=Y5] {$J$};

\node[box][above=0.4cm of X1](E1){$\varepsilon_A$};                  
\node[box, fill=blue, opacity=0.3, text opacity=1, draw opacity=1][above=0.4cm of X4](E4){$\varepsilon_D$};                  
\node[box,fill=blue, opacity=0.3, text opacity=1, draw opacity=1][above=0.4cm of X7](E7){$\varepsilon_G$};                  
\node[box][above=0.4cm of Y5](D5){$\varepsilon_I$};                  


\node[box, fill=SpringGreen][below=0.4cm of X4](P4){$\lambda_D$};                  
\node[box, fill=blue, opacity=0.3, text opacity=1, draw opacity=1][below=0.4cm of X5](P5){$\lambda_E$};                  
