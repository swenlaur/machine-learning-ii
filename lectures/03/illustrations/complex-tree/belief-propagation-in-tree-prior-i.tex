...
\node[state, fill=LimeGreen, draw=red, line width=2pt] (X4) [right of=X3] {$D$};                   
\node[state, draw=red, line width=2pt] (X5) [right of=X4,] {$E$}; 
\node[state, draw=red, line width=2pt] (X6) [right of=X5,] {$F$}; 
\node[state, fill=LimeGreen, draw=red, line width=2pt] (X7) [right of=X6,] {$G$}; 

\node[state, fill=OliveGreen, draw=red, line width=2pt] (Y4) [below=3.5cm of X3, right of=X3] {$H$};                   
\node[state, fill=LimeGreen] (Y5) [right of=Y4] {$I$};                   
\node[state] (Y6) [right of=Y5] {$J$};
...
\node[box, fill=red, opacity=0.3, text opacity=1, draw opacity=1][above=0.5cm of X7](E7){$\varepsilon_G$};                  
\node[box][above=0.5cm of Y5](D5){$\varepsilon_I$};                  


\node[box, fill=red, opacity=0.3, text opacity=1, draw opacity=1][below=0.5cm of X3, xshift=-1cm](P3){$\pi_C,\lambda_C,p_C$};                  

\node[box, fill=SpringGreen][below=0.5cm of Y4](Q4){$\lambda_D,\textcolor{red}{\pi_D}$};                  
