...
\item Marginalisation gives an update rule $\pi_B\propto \pi_A M_{b|a}$.
...
\illustration[scale=1.1]{likelihood-propagation-in-tree-i}
\vspace*{-2.5cm}
...
\illustration[scale=1.1]{prior-propagation-in-tree-i}
\vspace*{-2.5cm}
...
\foilhead[-1cm]{Prior propagation in a tree}
\illustration[scale=1.1]{prior-propagation-in-tree-ii}
