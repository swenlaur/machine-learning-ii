...
\begin{align*}
p_i&=\frac{\#\set{\text{data points form $Y= 0\wedge X_i=1$}}}{\#\set{\text{data points form $Y= 0$}}}\\
q_i&=\frac{\#\set{\text{data points form class $Y= 1\wedge X_i=1$}}}{\#\set{\text{data points form $Y= 0$}}}
\end{align*}
...
\begin{align*}
p_i&=\frac{\#\set{\text{data points form $Y= 0\wedge X_i=1$}}+1}{\#\set{\text{data points form $Y= 0$}}+2}\\
q_i&=\frac{\#\set{\text{data points form $Y= 1\wedge X_i=1$}}+1}{\#\set{\text{data points form $Y= 1$}}+2}
\end{align*}
