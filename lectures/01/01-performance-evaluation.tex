...
\item $\omega^2$ is the within-block covariance of test errors sharing the same test set. 
\item $\gamma^2$ is the between-block covariance of test errors cause by the fact that 
\begin{diamonds}
